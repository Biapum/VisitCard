...
@interface ContactEntity : NSObject
{
    ...
    NSData      *contactCardFrontData;
    NSData      *contactCardBackData;
...
@property (nonatomic,retain) NSData     *contactCardFrontData;
@property (nonatomic,retain) NSData     *contactCardBackData;
